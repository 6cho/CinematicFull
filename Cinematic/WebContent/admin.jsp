...
<body>
    ...
    <main class="main">
        <section class="textbox row">
			...
			<div class="col-xl-4" >
				<h2  class="center">Add Movie</h2>
				<div class="border mar-bottom-1"style="padding:20px;">
		            <form  onsubmit="return validateAddMovie()" action="AddMovieServlet" method="post">
				...
				<h2  class="center">Add Admin Users</h2>
				<div class="border mar-bottom-1"style="padding:20px;">
		            <form  onsubmit="return validateAdminRegistration()" action="AddAdminServlet" method="post">
